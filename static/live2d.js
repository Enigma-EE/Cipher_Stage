...
class Live2DManager {
    ...
    async loadModel(modelPath, options = {}) {
        ...
        try {
        // three-live2d v0.5.0 起弃用 autoInteract，改用 autoHitTest/autoFocus
        const model = await Live2DModel.from(modelPath, { autoHitTest: false, autoFocus: false });
...
window.LanLan1.setMouth = (value) => window.live2dManager.setMouth(value);
 ...
 // 新命名别名：与 LanLan1 保持一致
 window.EE1 = window.EE1 || {};
 window.EE1.setEmotion = window.LanLan1.setEmotion;
 window.EE1.playExpression = window.LanLan1.playExpression;
 window.EE1.playMotion = window.LanLan1.playMotion;
 window.EE1.clearEmotionEffects = window.LanLan1.clearEmotionEffects;
 window.EE1.clearExpression = window.LanLan1.clearExpression;
 window.EE1.setMouth = window.LanLan1.setMouth;
...
if (typeof cubism4Model !== 'undefined' && cubism4Model) {
 ...
 // 同步新命名别名
 window.EE1.live2dModel = window.LanLan1.live2dModel;
 window.EE1.currentModel = window.LanLan1.currentModel;
 window.EE1.emotionMapping = window.LanLan1.emotionMapping;
